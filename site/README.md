...
Windows와 macOS의 다운로드 버튼을 각각 표시합니다. Windows는 0.3.30, macOS는 0.3.27에 연결합니다. Mac용 0.3.30을 게시하면 macOS 버튼도 갱신합니다. macOS는 Apple 공증을 받은 DMG, Windows는 미서명 EXE를 제공하며 Windows 버튼 옆에 실행 차단·경고 가능성과 서명 심사 상태를 안내합니다. 2026년 9월 12일 유지관리자가 미서명 Windows 버전의 홈페이지 공개를 승인했습니다. 각 버튼은 해당 플랫폼의 설치 파일에 연결합니다.
