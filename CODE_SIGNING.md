...
- ADF 0.3.27: Windows는 미서명, macOS는 Developer ID 서명·Apple 공증 완료.
- Windows 소스 검사: 309개와 세부 검사 130개 통과. Windows Server 2022에서 설치·파일 대조·바로가기·앱 실행·문서 처리·제거 확인.
