...
- ADF 0.3.31: Windows는 미서명. macOS는 0.3.30 앱과 DMG가 Developer ID 서명·Apple 공증 및 Gatekeeper 검증 완료.
...
- Windows 소스 검사: 401개와 세부 검사 136개, 탐색기 확장 구성 요소 검사 14,567개 통과. Windows Server 2022에서 설치·파일 대조·바로가기·앱 실행·문서 처리·제거 확인.
